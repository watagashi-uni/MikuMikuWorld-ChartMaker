...
namespace MikuMikuWorld
{
	extern std::map<std::string, std::string> en
	{
		...
		{"startup_warning_hide", "Do not show this warning again"},
		{"startup_warning_confirm", "I Understand"},
		...
		{"sus_notespeed_export_warning", "This chart contains Notes Speed values. SUS does not support per-note Notes Speed, so those values will be lost when exporting. Continue?"},
		{"error", "Error"},
		{"error_reason", "Reason"},
